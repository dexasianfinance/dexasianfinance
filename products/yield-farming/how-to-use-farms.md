---
description: Yield Farming on Dex Asian is easy!
---
...
Yield Farming in Farms is a great way to earn DEX rewards on Alpine Dex.

Unlike Amazon Pools, Farms require you to stake **two tokens** to get LP Tokens, which you then stake in the Farm to earn rewards. This lets you earn DEX while still keeping a position in your other tokens!
...
You’re going to need some "LP Tokens" to enter into a Farm with. Farms can only accept their own exact LP Token; for example, the DEX-BNB Farm will only accept DEX-BNB LP Tokens.

To get the exact LP Token, you'll need to provide liquidity for that trading pair. So to get DEX-BNB LP Tokens, you'll first have to provide liquidity for the DEX-BNB pair.
...
DEX-BNB and BUSD-BNB are pinned to the top of the list with the default **Hot** sorting. After the pinned Farms, Hot will show other Farms in order of how new they are.

You can choose another sorting option if you like, such as by **APR** for the Farms with the highest reward rate currently.

When you find a Farm that you'd like to use, note down the trading pair, e.g. BNB-ADEX in case you need it later.
...
Farming will bring you DEX rewards over time. You can collect these rewards and use them to get more LP Tokens, stake them in Amazon Pools, use them to earn Pine, and get 5% USDT rewards, or anything else you’d like.

### Returning to your Farm to Harvest

You can harvest your Farm and Amazon Pool rewards together from the Home page. If you'd like to collect your farming rewards only, follow along.

To collect your rewards, you’ll need to visit your chosen Farm and collect the ADEX waiting for you.

1. Return to the Farms page [here.](broken-reference)
2. Find the Farm you staked your LP Tokens in, and click the row to view details. You should see an estimate of your rewards under “ADEX earned”.
...
1. Click the **Harvest** button and confirm the action in your wallet. After a short wait, the ADEX will be claimed to your wallet for you to use as you like.
...
And that's all there is to it! You may also want to look at how to use Alpine Dex Amazon Pools to earn rewards.
