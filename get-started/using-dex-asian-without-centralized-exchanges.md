# Using Dex Asian without Centralized Exchanges

![](../.gitbook/assets/usingdexwithoutcentralexchange.png)

Dex Asian is a decentralized application. That means, unlike Binance or other centralized platforms, you don't need to register account to use it... you just need a crypto wallet. So how can you get crypto onto Dex Asian without using a centralized exchange?

In this tutorial, we're going to guide you through the process of using "cross-chain bridges" to transfer your assets into your Binance Smart Chain wallet, and start using Dex Asian.
...
11. Once you complete the transaction. You should receive your fund in the Binance Smart Chain wallet in a few minutes. After that, you can start using Alpine Dex to swap some tokens on Binance Smart Chain!
{% endtab %}
...
10. Once finished. You should receive your fund in your BSC wallet. Now you can start using Alpine Dex to swap some tokens on Binance Smart Chain!
